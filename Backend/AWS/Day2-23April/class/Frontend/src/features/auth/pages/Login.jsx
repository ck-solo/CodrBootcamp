      ...
      <div className="max-w-md w-full space-y-8 bg-[#0B0B14]/80 backdrop-blur-xl p-8 sm:p-10 rounded-[1.5rem] border border-white/5 z-10 shadow-2xl">
        <div>
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-gray-400">
            Sign in to access your account with your Google or Apple ID, or use
            your credentials.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          <div className="text-sm">
            <a
              href="#"
              className="font-medium text-[#9333EA] hover:text-[#A855F7] transition-colors"
            >
              Forgot password?
            </a>
          </div>
          ...
          <div className="text-sm">
            <span className="text-gray-400">Need a new account? </span>
            <Link
              to="/register"
              className="font-medium text-[#9333EA] hover:text-[#A855F7] transition-colors"
            >
