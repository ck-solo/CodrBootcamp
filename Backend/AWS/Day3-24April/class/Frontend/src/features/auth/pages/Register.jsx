        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4" action="">
          ...
          <div className="mt-2">
            <label 
              ...
              className="flex items-center justify-between px-4 py-3.5 bg-[#151520] border border-dashed border-gray-700 rounded-[1.25rem] cursor-pointer hover:border-purple-500 hover:bg-[#1A1A28] transition-all group"
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-400 group-hover:text-gray-300">
                  {formData.profilePicture ? 'Image Selected' : 'Choose Profile Picture'}
                </span>
              </div>
              <span className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider">Upload</span>
            </label>
            <input
              id="profilePicture"
              type="file"
